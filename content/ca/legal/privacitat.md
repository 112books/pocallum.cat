...
- **Contacte:** <a href="#" data-contact="686f6c6140706f63616c6c756d2e636174"><span data-contact-text>Correu electrònic</span></a>
...
Quan envies un missatge a través del formulari de contacte, recollim les dades que tu mateix facilites:
...
Aquest web utilitza **GoatCounter** per mesurar el trànsit. GoatCounter és un sistema d'analítica web dissenyat per respectar la privacitat:
...
- **Suprimir** les teves dades
- **Oposar-te** al tractament
- **Obtenir la portabilitat** de les teves dades
- **Sol·licitar la limitació** del tractament

Per exercir-los, escriu a <a href="#" data-contact="686f6c6140706f63616c6c756d2e636174"><span data-contact-text>aquest correu</span></a>. Si consideres que el tractament de les teves dades no s'ajusta a la normativa, pots presentar una reclamació davant l'Agència Española de Protecció de Dades (www.aepd.es).

---

## Confidencialitat

Les dades que ens facilites es tractaran amb absoluta confidencialitat i no se cediran a tercers, excepte quan sigui necessari per a la prestació del servei contractat o per obligació legal.
